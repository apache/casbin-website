...
1. **Model and policy design** — Prefer RBAC and shared defaults so most tenants use a small rule set (e.g. &lt; 100 rules); override only where needed. See [GitHub #681](https://github.com/apache/casbin/issues/681#issuecomment-763801583) for discussion.
