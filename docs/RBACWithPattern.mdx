...
For the meaning of `g(r.sub, p.sub, r.dom)` see [RBAC with domains](/docs/rbac-with-domains). Full example: [model_test.go](https://github.com/apache/casbin/blob/dbdb6cbe2e7a80863e4951f9ff36da07fef01b75/model_test.go#L278-L307).
