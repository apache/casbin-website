...
:::tip
Policy rule elements are always treated as strings. See [casbin/casbin#113](https://github.com/apache/casbin/issues/113) for discussion.
:::
...
Example usage (see the [model](https://github.com/apache/casbin/blob/master/examples/multiple_policy_definitions_model.conf) and [policy](https://github.com/apache/casbin/blob/master/examples/multiple_policy_definitions_policy.csv) examples):
...
e.enforce("alice", "data2", "read");  // true
// Pass in EnforceContext
// TestEvalRule is located in https://github.com/apache/casbin-jcasbin/blob/master/src/test/java/org/casbin/jcasbin/main/AbacAPIUnitTest.java#L56
...
Reference examples: [rbac_model_matcher_using_in_op](https://github.com/apache/casbin/blob/277c1a2b85698272f764d71a94d2595a8d425915/examples/rbac_model_matcher_using_in_op.conf), [keyget2_model](https://github.com/apache/casbin/blob/277c1a2b85698272f764d71a94d2595a8d425915/examples/keyget2_model.conf), and [keyget_model](https://github.com/apache/casbin/blob/277c1a2b85698272f764d71a94d2595a8d425915/examples/keyget_model.conf).
...
|----------------|----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Casbin         | Golang   | [https://github.com/apache/casbin-govaluate](https://github.com/apache/casbin-govaluate)                                                                                                                               |
