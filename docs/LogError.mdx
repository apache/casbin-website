...
|-----------------------------------------------------------------------------------------------------|--------|--------------------------------------------------------------------------------------------------------------------------------|
| [Default logger (built-in)](https://github.com/apache/casbin/blob/master/log/default_logger.go)    | Casbin | The default logger using Go's standard log package.                                                                            |
| [Zap logger](https://github.com/apache/casbin-zap-logger)                                                    | Casbin | Uses [zap](https://github.com/uber-go/zap) for JSON-encoded logs with additional customization options via zap-logger.        |
...
Custom loggers must implement the [Logger](https://github.com/apache/casbin/blob/master/log/logger.go#L20) interface.
