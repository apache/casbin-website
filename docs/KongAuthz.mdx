...
**[kong-authz](https://github.com/casbin-lua/kong-authz)** is a Kong plugin that does request authorization with [lua-casbin](https://github.com/apache/casbin-lua-casbin). You define models and policies as usual; the plugin enforces them on Kong routes.
...
- [Lua Casbin](https://github.com/apache/casbin-lua-casbin/)
