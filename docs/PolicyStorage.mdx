...
Example: [examples/rbac_policy.csv](https://github.com/apache/casbin/blob/master/examples/rbac_policy.csv)
...
See [casbin#886](https://github.com/apache/casbin/issues/886).
:::
