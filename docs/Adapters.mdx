...
### [MySQL adapter](https://github.com/apache/casbin-mysql-adapter)
...
Additional examples: [https://github.com/apache/casbin-xorm-adapter/blob/master/adapter_test.go](https://github.com/apache/casbin-xorm-adapter/blob/master/adapter_test.go)

### How to write an adapter

Implement the [Adapter](https://github.com/apache/casbin/blob/master/persist/adapter.go) interface with at least two required methods: `LoadPolicy(model model.Model) error` and `SavePolicy(model model.Model) error`.
...
By convention, adapters should automatically create a `casbin` database if it doesn't exist and use it for policy storage. Reference implementation: [https://github.com/apache/casbin-xorm-adapter](https://github.com/apache/casbin-xorm-adapter)
...
[ContextAdapter](https://github.com/apache/casbin/blob/master/persist/adapter_context.go) provides context-aware operations for Casbin adapters.

Context enables features like timeout control for adapter API calls.

### Example

[gormadapter](https://github.com/apache/casbin-gorm-adapter) supports context. Below is timeout control using context:
...
Reference implementation: [adapter.go](https://github.com/apache/casbin-gorm-adapter/blob/master/adapter.go)
...
Implement `TransactionalAdapter` and `TransactionContext` from [persist/transaction.go](https://github.com/apache/casbin/blob/master/persist/transaction.go) to add transaction support.

Reference: [adapter.go](https://github.com/apache/casbin-gorm-adapter/blob/master/adapter.go)
